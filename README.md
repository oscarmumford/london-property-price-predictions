...
Ultimately, I managed to create a reliable Python web scraper to collect many of the previously sold properties listed on Zoopla and created models that capture most of a property's value from its location along with other predictive characteristics, such as, number of bedrooms.

## Hypothesis

- A property's sale price mostly comprises from the price of other comparible properties in its location.
